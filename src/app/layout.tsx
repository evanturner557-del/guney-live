  ...
  return (
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400..700;1,9..144,400..700&family=Inter:wght@400..700&display=swap" rel="stylesheet" />
      </head>
      <body className="min-h-screen flex flex-col">
        <Header signedIn={!!user} name={name} isAdmin={isAdmin} avatarUrl={avatarUrl} />
        <main className="flex-1">{children}</main>
        <footer className="mt-16">
          <div className="mx-auto max-w-6xl px-6 py-10 text-sm text-faded flex flex-wrap gap-4 justify-between items-center">
            <p className="whisper">Güney, Yeşilova, Burdur — the village, online.</p>
